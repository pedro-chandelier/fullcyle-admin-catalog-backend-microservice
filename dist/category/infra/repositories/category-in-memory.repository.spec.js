...
describe('CategoryInMemoryRepository Unit Tests', () => {
    const categories = [
        new category_1.Category({ name: 'cat_1', createdAt: new Date('2022-01-01'), description: 'desc_cat_1' }),
        new category_1.Category({ name: 'cat_4', createdAt: new Date('2022-01-04'), description: 'desc_cat_4' }),
        new category_1.Category({ name: 'CAT_1', createdAt: new Date('2022-01-05'), description: 'desc_cat_5' }),
        new category_1.Category({ name: 'cat_3', createdAt: new Date('2022-01-03'), description: 'desc_cat_3' }),
        new category_1.Category({ name: 'cat_2', createdAt: new Date('2022-01-02'), description: 'desc_cat_2' })
    ];

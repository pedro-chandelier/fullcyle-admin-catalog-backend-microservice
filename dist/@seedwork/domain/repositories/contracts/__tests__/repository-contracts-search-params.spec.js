...
describe('SearchParams Unit Tests', () => {
    test('page prop', () => {
        ...
        let params = new repository_contracts_search_params_1.SearchParams();
        expect(params.page).toBe(1);
        for (const testCase of testCases) {
            params = new repository_contracts_search_params_1.SearchParams({ page: testCase.page });
    ...
    test('per_page prop', () => {
        ...
        for (const testCase of testCases) {
            params = new repository_contracts_search_params_1.SearchParams({ per_page: testCase.per_page });
    ...
    test('sort prop', () => {
        ...
        for (const testCase of testCases) {
            params = new repository_contracts_search_params_1.SearchParams({ sort: testCase.sort });
    ...
    test('filter prop', () => {
        ...
        for (const testCase of testCases) {
            const params = new repository_contracts_search_params_1.SearchParams({ filter: testCase.filter });
